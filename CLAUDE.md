...
- Follow `docs/decisions/ADR-0016-repository-retention.md`: current `HEAD` describes current Fibre; Git history is the development archive.
- Milestone #39 is closed; use `docs/history/milestones/pr39.md` for its outcome and `docs/state/genesis-selectivity-scientific-hardening.md` for the current pre-#40 bridge.
