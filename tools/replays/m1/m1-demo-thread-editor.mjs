...
} from "./m1-thread-editor-server.mjs";
...
export async function startM1ThreadEditorFromEnvironment(environment = process.env) {
...
async function main() {
  const runtime = await startM1ThreadEditorFromEnvironment();
