...
test("retired proof and experiment tests are explicit reproducibility evidence", () => {
  ...
  for (const path of [
    ...
    "services/birth-center/test/genesis-development-plan.test.mjs",
    "services/birth-center/test/genesis-development-world-admission.test.mjs",
    "services/birth-center/test/genesis-history-generation.test.mjs",
    "services/birth-center/test/genesis-memory-generation.test.mjs",
    "services/birth-center/test/genesis-ownership-refactor.test.mjs",
    "services/fibre-identity-authority/test/fid-card-registry.test.mjs",
