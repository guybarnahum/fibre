...
import { attachThreadDirectoryBoundary } from "../../infra/deployments/thread-editor/thread-directory-boundary.mjs";
import {
...
async function main() {
  const runtime = await startThreadEditorDirectoryFromEnvironment();
