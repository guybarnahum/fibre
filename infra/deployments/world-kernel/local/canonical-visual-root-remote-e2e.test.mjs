...
test("World remote root handoff converges from durable pending workflow to Fibre-provenanced ready proof", async () => {
  ...
  assert.equal(ready.proof.receipt.sha256, ready.proof.receipt.providerOutputDigest);
