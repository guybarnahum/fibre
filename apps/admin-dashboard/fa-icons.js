// Font Awesome Free 6.7.2 solid SVG geometry.
...
export function faIcon(name, className = "fa-action-icon") {
  const definition = ICONS[name];
  if (!definition) throw new TypeError(`Unknown Font Awesome icon: ${name}`);
...
export function decorateActionButton(button, {
  icon,
  label,
  tooltip = label,
  iconOnly = false,
  ...
  if (iconOnly) button.classList.add("icon-only-action");
