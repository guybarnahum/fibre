...
The Threads view reuses the same projection and catalog to show **authoritative Thread birthplaces**, grouped into numeric location badges. It does not claim to show current location: continuous LivedNow is a separate capability. A legacy birthplace without a matching catalog coordinate remains explicitly unmapped rather than being guessed.
