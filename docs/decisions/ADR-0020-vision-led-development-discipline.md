...
This ADR complements, rather than weakens, [`ADR-0017-provider-neutral-production-persistence.md`](ADR-0017-provider-neutral-production-persistence.md). ADR-0017 defines the production boundary. ADR-0020 defines how much abstraction work belongs on the critical path at any given time.
