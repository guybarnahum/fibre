...
export async function generateGenesisHistoricalEpisode({ adapter, repairAdapter = adapter, passAInput, envelope, clientRequestId } = {}) {
  ...
  const invokeRealization = async ({ prompt, kind, failedGate = null, retryOrdinal = null }) => {
    const modelInput = failedGate === null ? cognitionInput : { ...cognitionInput, failedGate, retryOrdinal };
