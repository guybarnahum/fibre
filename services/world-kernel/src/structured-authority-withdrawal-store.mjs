...
export class StructuredAuthorityWithdrawalStore {
  ...
  constructor(storage) {
    this.#database = openWorldStateDatabase(storage, { storeName: "StructuredAuthorityWithdrawalStore" });
...
export function openStructuredAuthorityWithdrawalStore(storage) {
  return new StructuredAuthorityWithdrawalStore(storage);
}
