...
export const GENESIS_PASS_C_INITIAL_PROMPT = resolvePromptAsset({
  directory: GENESIS_PROMPT_DIRECTORY,
  id: "genesis.meaning-initial",
}).text;

// Frozen v1 reinterpretation prompt remains available by stable asset ID for
// historical compatibility. Runtime Genesis uses the restrained asset below.
export const GENESIS_PASS_C_REINTERPRETATION_PROMPT = resolvePromptAsset({
  directory: GENESIS_PROMPT_DIRECTORY,
  id: "genesis.meaning-reinterpretation.base",
}).text;

export const GENESIS_PASS_C_REINTERPRETATION_RESTRAINT_AMENDMENT = resolvePromptAsset({
  directory: GENESIS_PROMPT_DIRECTORY,
  id: "genesis.meaning-reinterpretation-restraint",
}).text;

export const GENESIS_PASS_C_REINTERPRETATION_RUNTIME_PROMPT = resolvePromptAsset({
  directory: GENESIS_PROMPT_DIRECTORY,
  id: "genesis.meaning-reinterpretation",
}).text;
