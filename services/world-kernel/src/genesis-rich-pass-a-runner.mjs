...
const prompt = (id) => resolvePromptAsset({ directory: GENESIS_PROMPT_DIRECTORY, id }).text;
...
export const GENESIS_RICH_PASS_A_PROMPT = prompt("genesis.rich-pass-a");
export const GENESIS_RICH_PASS_A_SELECTED_OPPORTUNITY_PROMPT = prompt("genesis.rich-pass-a-selected-opportunity");
export const GENESIS_RICH_PASS_A_REPAIR_PROMPT = prompt("genesis.rich-pass-a-repair");
export const GENESIS_RICH_PASS_A_RECORD_RETRY_PROMPT = prompt("genesis.rich-pass-a-record-retry");
export const GENESIS_RICH_PASS_A_SELECTED_OPPORTUNITY_RETRY_PROMPT = prompt("genesis.rich-pass-a-selected-opportunity-retry");
...
const G4_V3_FORM_TARGET = prompt("genesis.rich-pass-a-form-target");
