...
export function canonicalVisualIdentityBrief(embodimentCandidate) {
  ...
  return Object.freeze({
    ...
    constraints: [
      ...
      "When the identity specification states a concrete inherited phenotype selected for this individual, treat those selected skin, hair, eye, face, brow, nose, mouth, jaw, and build traits as hard identity constraints. Do not choose phenotype again and do not substitute generic portrait defaults.",
